...
export interface ApiDocumentationCategoryDocumentationCategory
  extends Struct.CollectionTypeSchema {
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    additionalNavigation: Schema.Attribute.Component<
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    eventSection: Schema.Attribute.Relation<'oneToMany', 'api::event.event'>;
...
export interface ApiNavbarNavbar extends Struct.SingleTypeSchema {
  ...
  attributes: {
    additionalNavigation: Schema.Attribute.Component<
      ...
      false
    >;
    brandImage: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
